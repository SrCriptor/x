...
-- Remove/crie o menu apenas quando o ícone for clicado
if menu then menu:Destroy() end

-- Ícone flutuante arrastável
local iconGui = Instance.new("ScreenGui")
iconGui.Name = "KryptonIconGUI"
iconGui.IgnoreGuiInset = true
iconGui.ResetOnSpawn = false
iconGui.Parent = LocalPlayer:WaitForChild("PlayerGui")

local iconBtn = Instance.new("ImageButton")
iconBtn.Name = "KryptonIcon"
iconBtn.Size = UDim2.new(0, 60, 0, 60)
iconBtn.Position = UDim2.new(0, 30, 0, 120)
iconBtn.BackgroundTransparency = 1
iconBtn.Image = "https://raw.githubusercontent.com/SrCriptor/x/refs/heads/main/2.ico"
iconBtn.Parent = iconGui

-- Drag funcional para o ícone
local draggingIcon, dragStartIcon, startPosIcon = false, nil, nil
...
local function createKryptonMenu()
    if menu then menu:Destroy() end

    menu = Instance.new("Frame")
    menu.Size = UDim2.new(0, 260, 0, 500)
    ...
    task.spawn(function()
        ...
        while title.Parent do
            ...
            title.TextStrokeColor3 = Color3.fromRGB(0, 255, 70)
            task.wait(0.04)
        end
    end)
    ...
    -- Aqui você pode adicionar o restante do seu menu (toggles, etc)
    -- ...adicione os elementos do menu aqui, como já faz no seu script...
end

-- Clique no ícone abre o menu
